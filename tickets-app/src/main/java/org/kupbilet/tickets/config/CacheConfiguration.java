package org.kupbilet.tickets.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(org.kupbilet.tickets.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(org.kupbilet.tickets.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
